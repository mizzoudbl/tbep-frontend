...
When you enter the main page of our website, simply click the tab "Search By Proteins" <img src="/image/docs/search-by-protein-button.png" alt="Search By Proteins Button" className="inline aspect-auto w-36"/> on the left panel, you will see the corresponding dashboard on the right as below:
...
You can also download the Found genes and/or Not-Found genes by clicking the download button <img src="/image/docs/download-button.png" alt="" className="inline aspect-square w-8"/>on the Results Preview window.
