...
At the main page of our website, you can also click the tab "Upload Network" <img src="/image/docs/upload-network-button.png" alt="" className="inline aspect-auto w-36"/> on the left panel, you will see the corresponding dashboard on the right as below:
