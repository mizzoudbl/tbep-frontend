...
Disease-dependent data includes [Differential Expression](../knowledge-base/disease-dependent-data/differential-expression.mdx) and [Target Disease Association ](../knowledge-base/disease-dependent-data/target-disease-association.mdx), while disease-independent data includes [Pathways](../knowledge-base/disease-independent-data/pathways.mdx), [Druggability](../knowledge-base/disease-independent-data/druggability.mdx) and [Tissue Specificity](../knowledge-base/disease-independent-data/tissue-specificity.mdx). We also call these data types as **features**.
...
1. Choose a feature.
   > **Note**: You can hover on the info icon <img src="/image/docs/info-tooltip.png" alt="" className="inline"/> to check the explanation.
