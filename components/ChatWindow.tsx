  ...
  return (
    <>
      <div className='absolute bottom-0 left-0 right-0 p-4'>
        <form onSubmit={handleSubmit} className='max-w-sm md:max-w-2xl mx-auto'>
          <AnimatePresence>
            {isChatOpen && (
              <motion.div
                ...
                className='relative bottom-2 max-w-sm md:max-w-2xl backdrop-blur rounded-lg shadow-lg overflow-hidden'
              >
                <motion.div
                  drag='y'
